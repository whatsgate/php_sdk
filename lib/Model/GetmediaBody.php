...
/**
 * GetmediaBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetmediaBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'getmedia_body';
...
'media_key' => 'getMediaKey'    ];
     ...
     * Sets whatsapp_id
     *
     * @param string $whatsapp_id Идентификатор Whatsapp ID
     *
     * @return $this
     */
     ...
     * Sets media_key
     *
     * @param string $media_key Идентификатор медиафайла, содержится во входящих сообщениях.
     *
     * @return $this
     */
